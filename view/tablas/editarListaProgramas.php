...
<head>
    ...
    <title>Editar Programas Educativos</title>
                ...
                <div class="container mt-4">
                    ...
                    <form method="POST"> <!-- ← Faltaba -->
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select name="nivel" class="form-select" required>
                                    ...
                                    <option value="Preescolar" <?= $programa['nivel'] == 'Preescolar' ? 'selected' : '' ?>>
                                        Preescolar</option>
                                    <option value="Primaria" <?= $programa['nivel'] == 'Primaria' ? 'selected' : '' ?>>
                                        Primaria
                                    </option>
                                    <option value="Secundaria" <?= $programa['nivel'] == 'Secundaria' ? 'selected' : '' ?>>
                                        Secundaria</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="mt-4">
                            ...
                            <a class="btn btn-secondary" href="listaProgramas.php">Cancelar</a>
                        </div>
                    </form>
